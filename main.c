...
int main(int argc, char **argv) {
    ...
    printf("memory_fetch_word(4): 0x%08x\n", memory_fetch_word(4));
    ...
    printf("memory_fetch_word(312): 0x%08x\n", memory_fetch_word(312));
    //printf("memory_fetch(312): %hhu\n", memory_fetch(312));
    //printf("memory_fetch(314): %hhu\n", memory_fetch(314));
    //printf("memory_fetch(315): %hhu\n", memory_fetch(315));
    memory_dump(270, 20);
    
    
    memory_store_word(16, 0x0a0b0c0d);
    printf("memory_fetch_word(16): 0x%08x\n", memory_fetch_word(16)); 
    ...
    printf("memory_fetch_word(100): 0x%08x\n", memory_fetch_word(100));
    ...
    memory_store_word(124, 0x0D000064); // BLT 100
    memory_store_word(128, 0x09000201); // CMP R2,R1
    memory_store_word(132, 0x0E000064); // BGT 100
    
    printf("memory_fetch_word(124): 0x%08x\n", memory_fetch_word(124));   
    memory_dump(80, 16);
    memory_dump(100,16);
    set_reg(PC, 100);    
    step();
    ...
    printf("Memory fetch word(312): 0x%08x\n", memory_fetch_word(312));
    ...
    while (1) {
		...
		if (strcmp(cmd, "set_reg") == 0) {
			...
			scanf("%d", &num1);
			set_reg(num, num1);
			printf("%d was stored in register %d\n", get_reg(num), num);
		}
